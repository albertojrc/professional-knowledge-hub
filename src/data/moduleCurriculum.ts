...
export const cfaCurriculum: ModuleCurriculum = {
  ...
  description: 'Choose a certification path first, then open each available concept in the full detail view.',
  submodules: [
    { id: 'cert-cfa-level-1', title: 'CFA Level I Foundations', objective: 'Build the core finance, economics, quant and investment base.', theory: ['Ethics', 'Quantitative methods', 'Economics', 'Financial reporting', 'Corporate issuers', 'Equity', 'Fixed income', 'Derivatives', 'Portfolio management'], assetIds: ['financial-ratios', 'cash-flow-analysis', 'wacc', 'capm', 'npv'], outputs: ['Formula sheet', 'Investment concept cards', 'Practice queue'] },
    { id: 'cert-bmc', title: 'Bloomberg Market Concepts', objective: 'Understand macro, markets, fixed income, equities and news interpretation.', theory: ['Economic indicators', 'Currencies', 'Fixed income', 'Equities', 'Market news'], assetIds: ['capm', 'npv', 'wacc'], outputs: ['Market brief', 'Indicator interpretation', 'Asset class note'] },
    { id: 'cert-bff', title: 'Bloomberg Finance Fundamentals', objective: 'Study company analysis, financial statements and market mechanics.', theory: ['Financial statements', 'Company analysis', 'Fixed income basics', 'Equity basics'], assetIds: ['financial-ratios', 'cash-flow-analysis', 'wacc'], outputs: ['Company snapshot', 'Ratio table', 'Finance note'] },
    { id: 'cert-terminal', title: 'Bloomberg Terminal Workflows', objective: 'Separate practical terminal workflows from conceptual certification learning.', theory: ['Navigation', 'Market monitor', 'Company lookup', 'Security lookup', 'Economic data'], assetIds: ['financial-ratios', 'cash-flow-analysis', 'capm'], outputs: ['Workflow checklist', 'Screen interpretation', 'Market research note'] }
  ]
}
