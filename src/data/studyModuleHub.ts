...
export const studyModuleCards: StudyModuleCard[] = [
  {
    ...
    description: 'Core analytics workflow: data quality, EDA, feature engineering, model validation and output interpretation.',
    studyGoal: 'Build a professional analytics workflow from raw data to business decision.',
    sourceMaterials: ['Variance and KS Testing', 'LC Data Dictionary', 'Graph Algorithms'],
    learningObjects: ['data-quality-report', 'eda', 'feature-engineering', 'analytical-base-table', 'ks-statistic'],
    formulas: ['missing-rate', 'join-match-rate', 'ks-statistic'],
    outputs: ['classification-report', 'data-quality-report-output', 'sql-join-reconciliation-output'],
    cases: ['credit-scoring-abt', 'sql-customer-360-case'],
    practice: ['interpret model validation outputs', 'map variables into an ABT', 'explain data quality risks'],
    linkedViews: ['data-science', 'academic-file-registry', 'output-atlas', 'formula-library']
  },
  {
