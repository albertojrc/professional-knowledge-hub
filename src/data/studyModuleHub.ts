...
export const studyModuleCards: StudyModuleCard[] = [
  ...
  },
  {
    ...
    sourceMaterials: ['Finance slides and Excel models pending review', 'SME financial ratio review case', 'cash-flow-credit-approval case'],
    learningObjects: ['financial-statement-foundations', 'financial-ratio-analysis', 'cash-flow-analysis', 'time-value-dcf-valuation', 'wacc-capm-cost-of-capital'],
    formulas: ['free-cash-flow', 'current-ratio', 'wacc', 'capm', 'npv', 'debt-service-coverage'],
    outputs: ['financial ratio table', 'cash flow bridge', 'DCF model summary', 'WACC sensitivity table'],
    cases: ['sme-financial-ratio-review', 'cash-flow-credit-approval', 'investment-analysis-case'],
    practice: ['interpret financial ratios', 'connect cash flow to credit approval', 'explain valuation assumptions', 'calculate simple WACC'],
    linkedViews: ['finance-valuation-study', 'formula-library', 'business-cases', 'output-atlas', 'professional-certifications']
  },
  {
