...
import { hubQASearchEntries } from './hubQASearch'
...
const creditGovernanceSearchEntries: SearchResultItem[] = [
  { id: 'search-model-ready-feature-set', title: 'Model-Ready Feature Set', kind: 'Governance Page', area: 'Banking Risk Analytics', category: 'Evidence & QA', summary: 'Leakage-safe feature promotion layer for credit scoring predictors, blocked fields and hold decisions.', tags: ['Sprint 5.9', 'ABT', 'feature selection', 'leakage', 'blocked fields', 'credit scoring', 'model matrix'], targetView: 'model-ready-feature-set' },
  { id: 'search-credit-scoring-experiment-blueprint', title: 'Credit Scoring Experiment Blueprint', kind: 'Governance Page', area: 'Banking Risk Analytics', category: 'Evidence & QA', summary: 'Experiment design layer for target definition, cutoff, feature matrix, baseline model, challengers, validation metrics and monitoring handoff.', tags: ['Sprint 5.10', 'target definition', 'AUC', 'Gini', 'KS', 'calibration', 'thresholds', 'credit scoring experiment'], targetView: 'credit-scoring-experiment-blueprint' },
  { id: 'search-model-card-monitoring-handoff', title: 'Model Card & Monitoring Handoff', kind: 'Governance Page', area: 'Banking Risk Analytics', category: 'Evidence & QA', summary: 'Model card and monitoring handoff for purpose, data lineage, target logic, validation, explainability, drift, ownership and limitations.', tags: ['Sprint 5.11', 'model card', 'monitoring', 'PSI', 'drift', 'reason codes', 'owners', 'limitations'], targetView: 'model-card-monitoring-handoff' },
  { id: 'search-portfolio-monitoring-dashboard-blueprint', title: 'Portfolio Monitoring Dashboard Blueprint', kind: 'Governance Page', area: 'Banking Risk Analytics', category: 'Evidence & QA', summary: 'Portfolio monitoring dashboard blueprint for score distribution, bad-rate, delinquency, PSI, calibration, vintage analysis, approval policy and alert triage.', tags: ['Sprint 5.12', 'portfolio monitoring', 'dashboard', 'score bands', 'bad-rate', 'delinquency', 'PSI', 'approval rate', 'vintage', 'alerts'], targetView: 'portfolio-monitoring-dashboard-blueprint' },
  { id: 'search-alert-remediation-workflow', title: 'Alert Playbook & Remediation Workflow', kind: 'Governance Page', area: 'Banking Risk Analytics', category: 'Evidence & QA', summary: 'Alert playbook and remediation workflow for trigger triage, owner assignment, root-cause diagnosis, escalation, evidence capture and closure criteria.', tags: ['Sprint 5.13', 'alert playbook', 'remediation', 'triage', 'owner', 'SLA', 'closure criteria', 'escalation', 'root cause'], targetView: 'alert-remediation-workflow' },
  { id: 'bf-model-refresh-challenger-review', title: 'Model Refresh & Challenger Review', kind: 'Governance Page', area: 'Banking Risk Analytics', category: 'Evidence & QA', summary: 'Sprint 5.14 visual governance path for model refresh triggers, champion/challenger comparison, recalibration, promotion decisions and post-refresh monitoring.', tags: ['Sprint 5.14', 'model refresh', 'champion challenger', 'challenger model', 'recalibration', 'calibration drift', 'model retraining', 'rollback plan', 'governance review'], targetView: 'banking-credit-risk-study' }
]
