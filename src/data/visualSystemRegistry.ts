...
export const visualSystemRegistry: VisualSystemEntry[] = [
  ...
  { id: 'abt-blueprint', label: 'ABT Design Blueprint', route: 'abt-blueprint', layer: 'pending', component: 'ABTBlueprintPage', status: 'blocked', notes: 'Conversion to VisualGovernanceStudio attempted but blocked by connector controls.' },
  { id: 'credit-scoring-experiment', label: 'Credit Scoring Experiment Blueprint', route: 'credit-scoring-experiment-blueprint', layer: 'pending', component: 'CreditScoringExperimentBlueprintPage', status: 'blocked', notes: 'Conversion attempted but blocked by connector controls.' },
  { id: 'model-card-monitoring', label: 'Model Card & Monitoring Handoff', route: 'model-card-monitoring-handoff', layer: 'pending', component: 'ModelCardMonitoringHandoffPage', status: 'blocked', notes: 'Conversion attempted but blocked by connector controls.' },
  { id: 'alert-remediation', label: 'Alert Playbook & Remediation Workflow', route: 'alert-remediation-workflow', layer: 'pending', component: 'AlertRemediationWorkflowPage', status: 'blocked', notes: 'Conversion attempted but blocked by connector controls.' }
]
