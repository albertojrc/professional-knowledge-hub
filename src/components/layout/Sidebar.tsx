...
const applicationNav: NavItem[] = [
  ...
  { id: 'interview-prep', label: 'Interview Prep', eyebrow: 'Career', description: 'STAR, technical and project defense drills.', icon: 'IP' },
  { id: 'role-readiness', label: 'Role Readiness', eyebrow: 'Career', description: 'Role roadmap and skills gap map.', icon: 'RR' },
...
const evidenceNav: NavItem[] = [
  { id: 'academic-upgrade-pass', label: 'Academic Upgrade Pass', eyebrow: 'Backstage', description: 'Controlled source-to-study upgrade queue.', icon: 'AU' },
  { id: 'academic-notes', label: 'Academic Notes', eyebrow: 'Backstage', description: 'Document extraction notes and pending refs.', icon: 'AN' },
  { id: 'credit-scoring-review', label: 'Credit Scoring Review', eyebrow: 'Backstage', description: 'RetailCreditScoring review pass.', icon: 'CS' },
  { id: 'credit-promotion-queue', label: 'Credit Promotion Queue', eyebrow: 'Backstage', description: 'Credit scoring update decisions.', icon: 'CQ' },
  { id: 'lc-field-mapping', label: 'LC Field Mapping', eyebrow: 'Backstage', description: 'LCDataDictionary field groups and ABT map.', icon: 'LC' },
  { id: 'hub-qa-polish', label: 'Hub QA Polish', eyebrow: 'Backstage', description: 'Final navigation and quality polish.', icon: 'HQ' },
