...
const groups = [
  { title: 'Study Modules', ids: ['dashboard', 'study-modules', 'data-science-analytics-study', 'finance-valuation-study', 'banking-credit-risk-study', 'professional-certifications', 'global-search', 'knowledge-library', 'study-paths', 'learning-session', 'data-science', 'banking-finance', 'credit-risk', 'business-os'] as ViewId[] },
