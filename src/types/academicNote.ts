export type AcademicNoteStatus = 'Pending' | 'Draft' | 'Needs refs' | 'Review ready'
...
export interface AcademicNoteSummary { total:number; pending:number; draft:number; needsRefs:number; reviewReady:number }
