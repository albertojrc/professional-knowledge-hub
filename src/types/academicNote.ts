export type AcademicNoteStatus = string
...
export interface AcademicNoteSummary { total:number; pending:number; draft?:number; firstPass?:number; needsRefs:number; reviewReady:number }
