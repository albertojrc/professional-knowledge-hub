...
const s=[['src/types/knowledge.ts','academic-file-registry'],['src/app/App.tsx','AcademicSourceRegistryPage'],['src/components/layout/Sidebar.tsx','PKOS v3.2'],['src/data/sourceGovernanceSearch.ts','search-academic-file-registry'],['src/data/searchIndex.ts','academic-file-registry'],['src/main.tsx','academicSourceOS.css']]
